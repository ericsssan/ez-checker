...
pub const Parser = struct {
    ...
    exported_names: std.ArrayListUnmanaged([]const u8) = .empty,
    ...
    private_decls: std.ArrayListUnmanaged([]const u8) = .empty,
    /// Flat stack of pending #x references (token of the `#` punctuator).
    private_refs: std.ArrayListUnmanaged(TokenIndex) = .empty,
    ...
    pending_export_local_toks: std.ArrayListUnmanaged(TokenIndex) = .empty,
    ...
    tok_mut_log: std.ArrayListUnmanaged(TokMut) = .empty,
    ...
    pub fn parseProgram(self: *Parser) !void {
            ...
            self.emit_scope_events)
        {
            ...
            defer decl_names.deinit(self.gpa);
            {
                ...
                var fn_stack: std.ArrayListUnmanaged(bool) = .empty;
    ...
    fn skipImportAttributes(self: *Parser) !void {
            ...
            self.peekAt(1) == .l_brace)
        {
            ...
            var key_offsets: std.ArrayListUnmanaged(struct { start: u32, len: u32 }) = .empty;
