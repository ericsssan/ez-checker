...
[![TypeScript corpus](https://img.shields.io/badge/TypeScript_corpus-84.6%25-brightgreen)](#conformance)
...
| --- | --- | --- | --- |
| All expression types | 556,287 | 657,474 | **84.6%** |
| Primitive types (sub-metric) | 338,655 | 372,262 | **91.0%** |
