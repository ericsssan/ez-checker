...
[![TypeScript corpus](https://img.shields.io/badge/TypeScript_corpus-84.2%25-brightgreen)](#conformance)
...
| --- | --- | --- | --- |
| All expression types | 553,752 | 657,474 | **84.2%** |
| Primitive types (sub-metric) | 338,482 | 372,262 | **90.9%** |
