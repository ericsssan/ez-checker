...
[![TypeScript corpus](https://img.shields.io/badge/TypeScript_corpus-85.1%25-brightgreen)](#conformance)
...
| --- | --- | --- | --- |
| All expression types | 559,286 | 657,474 | **85.1%** |
| Primitive types (sub-metric) | 339,097 | 372,262 | **91.1%** |
