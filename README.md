...
[![TypeScript corpus](https://img.shields.io/badge/TypeScript_corpus-84.9%25-brightgreen)](#conformance)
...
| --- | --- | --- | --- |
| All expression types | 558,202 | 657,474 | **84.9%** |
| Primitive types (sub-metric) | 338,738 | 372,262 | **91.0%** |
