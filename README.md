...
[![TypeScript corpus](https://img.shields.io/badge/TypeScript_corpus-85.0%25-brightgreen)](#conformance)
...
| --- | --- | --- | --- |
| All expression types | 559,194 | 657,474 | **85.0%** |
| Primitive types (sub-metric) | 339,027 | 372,262 | **91.1%** |
